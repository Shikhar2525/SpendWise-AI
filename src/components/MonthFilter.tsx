...
import { CalendarClock, Calendar, Zap } from 'lucide-react';
    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-2 rounded-2xl shadow-sm mb-4">
      ...
      <div className="flex flex-wrap items-center gap-2 pr-1">
        ...
        <button 
          ...
          className="group relative flex items-center gap-3 h-10 px-4 rounded-xl bg-zinc-900 dark:bg-white text-white dark:text-black hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-zinc-200 dark:shadow-none overflow-hidden"
        >
          ...
          <input 
            ...
            className="absolute inset-0 opacity-0 cursor-default pointer-events-none -z-10"
            tabIndex={-1}
          />
        </button>
      </div>
